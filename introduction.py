...
#For this exercise, we'll return to the King County housing 
#transaction dataset from chapter 2. We will again
#develop and train a machine learning model to predict house prices; 
#however, this time, we'll do it using the estimator API.
#Rather than completing everything in one step, we'll break this procedure down
#into parts. We'll begin by defining the feature columns and loading the data.
